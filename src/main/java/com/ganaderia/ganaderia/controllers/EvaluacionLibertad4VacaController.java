...
@Controller
@RequestMapping("/evaluacion/libertad4-vaca")
public class EvaluacionLibertad4VacaController {
	...
	public String agregar(Model model, @PathVariable String codEc, @PathVariable String codElvaca) {
		...
		return "redirect:/evaluacion/libertad4-vaca/nuevo";
	}
	...
	public String vista(Model model) {
		...
		return "evaluacion-libertad4-vaca";
	}
	...
	public String save(@Validated EvaluacionVaca elv, BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "redirect:/evaluacion/libertad4-vaca/" + elv.getCodEc();
		}
		...
		String l4 = String.valueOf(service.save(elv));

		return "redirect:/evaluacion/libertad5-vaca/".concat(serviceAnimales.getCodEc()).concat("/").concat(l4);
